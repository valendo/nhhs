...
--
-- Host: localhost
-- Generation Time: Oct 15, 2014 at 04:42 PM
...
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='File usage table. Track which modules uses which files';
...
('Ip', 'lastSystemMessageSent', '"65dc55bc2956feb83943751f79f536f2"'),
...
('Cron', 'lastExecutionStart', '1413385202'),
('Admin', 'failedLogins', '[]'),
('Cron', 'lastExecutionEnd', '1413385202'),
