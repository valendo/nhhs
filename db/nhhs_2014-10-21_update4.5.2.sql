...
--
-- Host: localhost
-- Generation Time: Oct 21, 2014 at 05:11 PM
...
(4, 'vi', '', 1, 0, 'Trang chủ', '', '', '', 'default', '', NULL, '', 1, 0, 0, 0, 0, '2014-10-21 15:25:53', '2014-10-20 17:00:00', NULL),
...
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='File usage table. Track which modules uses which files';
...
(32, 'img12.jpg', 'Table_product_picture', 'file/repository/', 1, 1413900704),
...
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='Cropped versions of original image file';
...
('Cron', 'lastExecutionStart', '1413907558'),
('Admin', 'failedLogins', '[]'),
('Cron', 'lastExecutionEnd', '1413907558'),
...
--
ALTER TABLE `ip_repository_reflection`
MODIFY `reflectionId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=39;
--
-- AUTO_INCREMENT for table `ip_revision`
--
ALTER TABLE `ip_revision`
MODIFY `revisionId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=46;
--
