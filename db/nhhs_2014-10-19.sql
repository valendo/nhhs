...
--
-- Host: localhost
-- Generation Time: Oct 18, 2014 at 06:14 PM
...
(4, 'vi', '', 1, 0, 'Trang chủ', '', '', '', 'default', '', NULL, '', 1, 0, 0, 0, 0, '2014-10-18 12:59:12', '2014-10-17 17:00:00', NULL),
...
(10, 'vi', 'thuc-don', 1, 2, 'Thực đơn', '', '', '', 'default', '', NULL, '', 1, 0, 0, 0, 0, '2014-10-18 15:51:21', '2014-10-17 17:00:00', NULL),
...
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='File usage table. Track which modules uses which files';
...
(20, 'img12.jpg', 'Table_product_picture', 'file/repository/', 1, 1413640505),
(17, '', 'Table_product_picture', 'file/repository/', 2, 1413639664),
(19, '', 'Table_product_picture', 'file/repository/', 2, 1413640489),
(21, 'img11.jpg', 'Table_product_picture', 'file/repository/', 4, 1413640642),
(22, 'img10.jpg', 'Table_product_picture', 'file/repository/', 2, 1413640653),
(23, 'img8.jpg', 'Table_product_picture', 'file/repository/', 3, 1413640665);
...
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='Cropped versions of original image file';
...
('Cron', 'lastExecutionStart', '1413651618'),
('Admin', 'failedLogins', '[]'),
('Cron', 'lastExecutionEnd', '1413651622'),
...
--
ALTER TABLE `ip_repository_reflection`
MODIFY `reflectionId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT for table `ip_revision`
--
ALTER TABLE `ip_revision`
MODIFY `revisionId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
--
